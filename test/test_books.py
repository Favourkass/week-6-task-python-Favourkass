...
class TestBooks(unittest.TestCase):
    ...
    def test_fetch_book(self):
        self.test_fetch_book = self.database.fetch_book(1)
        self.assertIsInstance(self.test_fetch_book, type(self.test_fetch_book))
    ...
    def test_create_book(self):
        self.test_create_book = self.database.create_book(3, 'Lord Of The Rings vol 2', 350)
